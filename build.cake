...
Task("patch-assembly-info")
    .Does(() =>
    {
        CreateAssemblyInfo("./src/Cake.Plist/Properties/AssemblyInfo.cs", new AssemblyInfoSettings {
...
Task("pack")
    .Does(() => 
    {
        ...
        NuGetPack(new NuGetPackSettings 
        {
            ...
            Authors                 = new[] { authors },
            Owners                  = new[] { owner },
            Description             = "Plist Addin for Cake Build Automation System",
            Summary                 = "The Plist Addin for Cake allows you to generated API documentation directly from .NET source code.",
            ProjectUrl              = new Uri("https://github.com/reicheltp/Cake.Plist"),
          //  IconUrl                 = new Uri("http://cdn.rawgit.com/SomeUser/TestNuget/master/icons/testnuget.png"),
            LicenseUrl              = new Uri("https://github.com/reicheltp/Cake.Plist/blob/master/LICENSE.md"),
            Copyright               = copyright,
          //  ReleaseNotes            = new [] {"Bug fixes", "Issue fixes", "Typos"},
            Tags                    = new [] {"Cake", "Script", "Build", "Plist", "Documentation" },
            RequireLicenseAcceptance= false,
            Symbols                 = false,
            NoPackageAnalysis       = true,
            Files                   = new [] 
            {
                new NuSpecContent {Source = "Cake.Plist.dll", Target = "net45"},
                new NuSpecContent {Source = "Cake.Plist.pdb", Target = "net45"},
                new NuSpecContent {Source = "Cake.Plist.xml", Target = "net45"},
            },
            BasePath                = "./src/Cake.Plist/bin/release",
